...
window.__mulang = {
  ...
  nl: {
    ...
    pay_headline:'Maksaminen',
    amount: 'Määrä: <strong>{0} {1}</strong>',
    intro:'Intro',
    card_holder:'Kortinomistajan nimi',
    ...
    pay_button:'Maksa',
    safe_text:'Mondido on PCI DSS Level 1 sertifioitu ja käyttää HTTPS / TLS salausta, Joka on pankkialan standardi.',
    loading: 'Ladataan',

    exp_month: 'Kuukausi',
    exp_year: 'Vuosi',
    card_not_accepted: '{card} Korttia ei hyväksytty',
    failed_message: 'Maksu hylättiin, yritä uudelleen uudella kortilla tai tarkista numerot.',
    validation_message: 'Sinun on täytettäva kaikki kentät:\n',
    choose_payment_option: 'Valitse toinen maksuvaihtoehto',
    processing_secure_payment: 'Processing secure payment',
